Level = {
    ...
    ----------------------------------------------------
    assets = {
        [0] = { type = "texture", id = "tilemap-texture", path = "tilemaps/desert.png" },
        { type = "texture", id = "tank-texture", path = "images/tank-panther-spritesheet.png" },
        ...
        { type = "texture", id = "army-gun-killed-texture", path = "images/army-walk-killed.png" },
